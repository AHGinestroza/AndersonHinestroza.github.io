...
<head>
    ...
    <title>Portafolio de Anderson Hinestroza</title>
    ...
    <div id="hero" class="hero">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h1>Anderson Hinestroza</h1>
                    <div class="page-scroll">
                        <p class="job-title">Technologist in analysis and development of software</p>
                ...
                <div class="col-md-6 text-right">
                    <img src="assets/img/myphoto2024OK.png" alt="myphoto2024OK">
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <p>Hello! I'm Anderson, a technologist in analysis and development of software. I studied in SENA.<br> I like to learn new things of programming world.<br> I love tennis and soccer. I’m currently available for work.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="service">
                            ...
                            <h4>Back-end</h4>
                            <p>I have experience in PHP, JavaScript and Java.</p>
                        </div><!-- /.service -->
                    </div>
                    <div class="col-sm-6">
                        <div class="service">
                            ...
                            <h4>Front-end</h4>
                            <p>I have experience using HTML5 and CSS3 and CMS Wordpress and Joomla.</p>
                        </div><!-- /.service -->
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Web Page - Restaurant</h4>
                                <a href="https://github.com/AHGinestroza/webpage_restaurant" data-toggle="modal" data-target="#portfolioItem1"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="https://github.com/AHGinestroza/webpage_restaurant"><span class="glyphicon glyphicon-link"></span></a>
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Web Page - Hotel</h4>
                                <a href="https://github.com/AHGinestroza/webpage_hotel" data-toggle="modal" data-target="#portfolioItem2"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="https://github.com/AHGinestroza/webpage_hotel"><span class="glyphicon glyphicon-link"></span></a>
                            </div><!-- /.portfolio-item-info -->
                        </div><!-- /.portfolio-item -->
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Calculator</h4>
                                <a href="https://github.com/AHGinestroza/calculator" data-toggle="modal" data-target="#portfolioItem3"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="https://github.com/AHGinestroza/calculator"><span class="glyphicon glyphicon-link"></span></a>
                            </div><!-- /.portfolio-item-info -->
                        </div><!-- /.portfolio-item -->
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <p class="counter start" data-to="1" data-speed="2000">0</p>
    ...
    <footer id="colophon" class="site-footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-0 col-xs-6 col-xs-offset-3"><p class="copyright">2024. All Rights Reserved</p></div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>Web page for a resturant.</p>
          </div>
          <div class="modal-footer">
            <a href="C:\xampp\htdocs\restaurante parrilla\restaurant-bootstrap-main\index.html" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>Web page for a hotel: Innovative and persuasive.</p>
          </div>
          <div class="modal-footer">
            <a href="C:\xampp\htdocs\hotel hh\blue-pro-bootstrap-main\theme\index.html" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>Project made in HTML, CSS and JavaScript.</p>
          </div>
          <div class="modal-footer">
            <a href="C:\xampp\htdocs\portafolio\calculadora\index.html" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div id="portfolioItem4" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title">Future Project </h4>
            <p>Future project.</p>
          </div>
          <div class="modal-footer">
